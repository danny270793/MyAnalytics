...
public class AuthControllerTests
{
    ...
    [Fact]
    public async Task Logout_WithInvalidAuthorizationFormat_ReturnsBadRequest()
    {
        var dbContext = Database.GetInMemoryDbContext();
        var controller = new AuthController(dbContext);
        controller.ControllerContext = new ControllerContext
        ...
        controller.Request.Headers["Authorization"] = "InvalidFormat token";
    ...
    [Fact]
    public async Task Refresh_WithInvalidAuthorizationFormat_ReturnsBadRequest()
    {
        var dbContext = Database.GetInMemoryDbContext();
        var controller = new AuthController(dbContext);
        controller.ControllerContext = new ControllerContext
        ...
        controller.Request.Headers["Authorization"] = "Bearer token-instead-of-refresh";
